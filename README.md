...
- Real AI message helper using the OpenAI API
...
The OpenAI API key is used by the AI message helper.  
...
My github link- https://github.com/adiburshan/BabysitterApp--FrontEnd.git
